              ...
              <div className="card-header">
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <p className="nama">
                      Last Update: <b>Saturday, 29 April 2023</b>
                    </p>
                  </div>
                  <div className="col-md-6">
                    <ul
                    ...
                    >
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="true"
                        >
                          <span className="nama">Total</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Internal</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Partner</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Offline</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Cost Iklan</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Manpower</span>
                        </button>
                      </li>
                      <li className="nav-item">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <span className="nama">Stock</span>
                        </button>
                      </li>
                    </ul>
                    <div className="">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-3">
                      <div className="card card-success">
                        <div className="card-header">
                          <p className="card-title">
                            Selisih Kumulatif Target & Omset
                          </p>
                        </div>
                        <div className="card-body">The body of the card</div>
                      </div>
