                ...
                <div className="card card-success card-outline card-outline-tabs">
                  <div className="card-header p-0 pt-0">
                    <ul className="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                      <li className="nav-item">
                        <a className="nav-link active" id="custom-tabs-one-pesan-tab" data-toggle="pill" href="#custom-tabs-one-pesan" role="tab" aria-controls="custom-tabs-one-pesan" aria-selected="true">{" "}<i className="fas fa-envelope" />Pesan<span className="badge bg-primary float-right">12</span></a>
                      </li>
                      <li className="nav-item">
                      <a className="nav-link" id="custom-tabs-one-memo-tab" data-toggle="pill" href="#custom-tabs-one-memo" role="tab" aria-controls="custom-tabs-one-memo" aria-selected="false">{" "}<i className="fas fa-book" />Memo<span className="badge bg-primary float-right">5</span></a>
                      </li>
                      <li className='col-5' />
